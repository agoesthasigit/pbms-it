-- ============================================================================
-- PORTAL DISTRIBUTOR — Phase 0 (lanjutan): Pemeriksaan Data grup F
-- Menambah 1 cek integritas untuk staging portal:
--   F1 — pengajuan berstatus 'accepted' tapi tak menunjuk pembelian yang valid
--        (purchase_id null / pembelian hilang). Seharusnya 0: accept selalu
--        menautkan purchase_id, unaccept mengembalikan ke draft.
-- CREATE OR REPLACE (tanda tangan sama) — hanya menambah F1 di akhir array.
-- ============================================================================
